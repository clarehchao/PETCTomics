...
if __name__ == '__main__':
    ...
    # clf_name = 'L1Liblinear'
    # clf_name = 'L2LbfgsLogReg'
    # clf_name = 'L2LiblinearLogReg'
    # clf_name = 'L2NewtoncgLogReg'
    # clf_name = 'L2SagLogReg'
    ...
    # params_dict = {'penalty': ['l1'], 'solver': ['liblinear'], 'C': [0.001, 0.01, 0.1, 1, 10, 1000],'max_iter': [5000, 10000, 20000, 30000]}
    ...
    # params_dict = {'solver': ['newton-cg'], 'C': [0.001, 0.01, 0.1, 1, 10, 1000], 'max_iter': [5000, 10000, 20000, 30000]}
    # params_dict = {'solver': ['sag'], 'C': [0.001, 0.01, 0.1, 1, 10, 1000],'max_iter': [5000, 10000, 20000, 30000]}
