...
if __name__ == '__main__':
    ...
    the_img_spacing = [0.5,0.5,0.5]  #in millimeter
    ...
    for pt_id in the_select_ids:
        ...
        #             resampled_itk_mask = itkif.ITKImageResample(ser_mask_sagittal_roi,the_img_spacing)
        #
        #         # get the image VOI
        ...
        #         resampled_itk_img = itkif.ITKImageResample(mri_itk_sagittal_roi,the_img_spacing)
        #
        #         # visual checking of images and mask
        ...
        #         theimf = ImF.ImageFeature(resampled_itk_img,feature_list,resampled_itk_mask)
        #
        #         for bb in glcm_Nbin:
